...
function nameAndAge() {
   ...
   * */
  const customObjectsArray = books.map((book) => {
    const object = {};
    object['author'] = book.author.name;
    const ageWhenBookWasReleased = book.releaseYear - book.author.birthYear
    object['age'] = ageWhenBookWasReleased;
    return object;
  });
  customObjectsArray.sort((a, b) => a.age - b.age);
  console.table(customObjectsArray);
  return customObjectsArray;
}
